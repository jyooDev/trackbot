...
#include "sl_i2cspm_I2C0_config.h"
#include "sl_i2cspm_I2C1_config.h"

sl_i2cspm_t *sl_i2cspm_I2C0 = SL_I2CSPM_I2C0_PERIPHERAL;
sl_i2cspm_t *sl_i2cspm_I2C1 = SL_I2CSPM_I2C1_PERIPHERAL;

#if SL_I2CSPM_I2C0_SPEED_MODE == 0
#define SL_I2CSPM_I2C0_HLR i2cClockHLRStandard
#define SL_I2CSPM_I2C0_MAX_FREQ I2C_FREQ_STANDARD_MAX
#elif SL_I2CSPM_I2C0_SPEED_MODE == 1
#define SL_I2CSPM_I2C0_HLR i2cClockHLRAsymetric
#define SL_I2CSPM_I2C0_MAX_FREQ I2C_FREQ_FAST_MAX
#elif SL_I2CSPM_I2C0_SPEED_MODE == 2
#define SL_I2CSPM_I2C0_HLR i2cClockHLRFast
#define SL_I2CSPM_I2C0_MAX_FREQ I2C_FREQ_FASTPLUS_MAX
#endif
...
I2CSPM_Init_TypeDef init_I2C0 = { 
  .port = SL_I2CSPM_I2C0_PERIPHERAL,
  .sclPort = SL_I2CSPM_I2C0_SCL_PORT,
  .sclPin = SL_I2CSPM_I2C0_SCL_PIN,
  .sdaPort = SL_I2CSPM_I2C0_SDA_PORT,
  .sdaPin = SL_I2CSPM_I2C0_SDA_PIN,
  .i2cRefFreq = 0,
  .i2cMaxFreq = SL_I2CSPM_I2C0_MAX_FREQ,
  .i2cClhr = SL_I2CSPM_I2C0_HLR
};
